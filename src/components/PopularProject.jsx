...
export function PopularProject(){
                                ...
                                <div className="project__item">
                                    <div className="project__item-inner">
                                        <div className="project__item-thumb">
                                            ...
                                            <span className="badge"><img src="assets/images/chain/solana.png"
                                                    alt="chain logo"/></span>
                                        </div>
                                        <div className="project__item-content">
                                            <div className="project__item-top">
                                                <div className="project__item-author">
                                                    <a href="javascript:void(0);"><img src="assets/images/igo/author/1.png"
                                                            alt="author image"/></a>
                                                    <h4 >Dexer Xone</h4>
                                                </div>
                                            ...
                                            <div className="project__item-bottom">
                                                ...
                                                <a href="pjavascript:void(0);"
                                                    className="default-btn default-btn--small">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="project__item">
                                    <div className="project__item-inner">
                                        <div className="project__item-thumb">
                                            ...
                                            <span className="badge"><img src="assets/images/chain/metic.png"
                                                    alt="chain logo"/></span>
                                        </div>
                                        <div className="project__item-content">
                                            <div className="project__item-top">
                                                <div className="project__item-author">
                                                    <a href="javascript:void(0);"><img src="assets/images/igo/author/2.png"
                                                            alt="author image"/></a>
                                                    <h4>DeFianXer 3dX</h4>
                                                </div>
                                            ...
                                            <div className="project__item-middle">
                                                ...
                                                <div className="project__item-amount">
                                                    ...
                                                    <div className="progress">
                                                        <div className="progress-bar bar2" role="progressbar"
                                ...
                                <div className="project__item">
                                    <div className="project__item-inner">
                                        <div className="project__item-thumb">
                                            ...
                                            <span className="badge"><img src="assets/images/chain/binance.png"
                                                    alt="chain logo"/></span>
                                        </div>
                                        <div className="project__item-content">
                                            <div className="project__item-top">
                                                <div className="project__item-author">
                                                    <a href="javascript:void(0);"><img src="assets/images/igo/author/3.png"
                                                            alt="author image"/></a>
                                                    <h4>Fire Xon</h4>
                                                </div>
                                ...
                                <div className="project__item">
                                    <div className="project__item-inner">
                                        ...
                                        <div className="project__item-content">
                                            <div className="project__item-top">
                                                <div className="project__item-author">
                                                    <a href="javascript:void(0);"><img src="assets/images/igo/author/6.png"
                                                            alt="author image"/></a>
                                                    <h4>DocR Chain</h4>
                                                </div>
